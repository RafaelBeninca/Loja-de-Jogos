...
Revision ID: 92f5c8096ba3
Revises: 8554cb726255
Create Date: 2024-06-17 20:01:32.984883
...
revision = '92f5c8096ba3'
down_revision = '8554cb726255'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('game', schema=None) as batch_op:
        ...
        batch_op.alter_column('blob_name_prefix',
               ...
               type_=sa.Text(length=200),
               existing_nullable=False)
        batch_op.alter_column('game_file_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('banner_image_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('trailer_1_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('trailer_2_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('trailer_3_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('preview_image_1_link',
               existing_type=mysql.VARCHAR(length=500),
               type_=sa.Text(length=200),
               existing_nullable=True)
        batch_op.alter_column('preview_image_2_link',
               existing_type=mysql.VARCHAR(length=200),
               type_=sa.Text(length=200),
               existing_nullable=True)
