    ...
    <>
      {game.id === 0 ? (
        ...
        <Box>
          ...
          >
            <Carousel width={500} emulateTouch={true} useKeyboardArrows={true} showStatus={false} showThumbs={false}>
              <div>
                <img src={game.banner_image} alt="" draggable="false" />
              </div>
              <div>
                <img src={game.banner_image} alt="" draggable="false" />
              </div>
              ...
              <div>
                ...
                >
                  ...
                  <p style={{ display: "inline" }}>
                    <b>{getReviewUser(review).username}</b>
                  </p>
                </Link>
                ...
                {review.user_id === parseInt(user.id) && !isUpdatingReview && (
                  <>
                    <button onClick={() => handleOnDeleteReview(review.id)}>
                      Delete
                    </button>
                    <button onClick={() => setIsUpdatingReview(true)}>
                      Update
                    </button>
